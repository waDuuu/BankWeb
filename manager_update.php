...
<p>
	<input type="submit" name="submitbt" style="width: 100px; height: 40px;" value="Update Access">
</p>
</form>
...
$query = "UPDATE `account` SET `ID`= '$ID',`bsb`= '$bsb',`accountNumber`='$accountNumber',`accountType`='$accountType', `access`='$access' WHERE ID = '$ID';";
